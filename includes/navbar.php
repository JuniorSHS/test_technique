...
<li class="nav-item">
  <a class="nav-link" href="utilisateurs.php">
    ...
    <span>Ajouter Utilisateurs</span></a>
</li>
     
<li class="nav-item">
    <a class="nav-link" href="poste.php">
    <i class="fas fa-laptop"></i>
    <span>Ajouter un Ordinateur</span></a>
</li>

<li class="nav-item">
  <a class="nav-link" href="computer.php">
    <i class="fas fa-address-card"></i>
    <span>Attribuer un poste</span></a>
</li>
...
<form action="logout.php" method="POST">
   <a class="nav-link" href="logout.php" name="logout_btn" data-toggle="modal" data-target="#logoutModal">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Vous êtes sur le point de vous déconnecter.</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <div class="modal-body">Cette action entrainera la perte des informations non sauvegardé.</div>
